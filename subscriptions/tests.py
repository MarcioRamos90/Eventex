...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expected = ['contato@eventex.com.br', 'marcioalvesramos90@hotmail.com']
        self.assertEqual(expected, email.to)
    
    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Marcio Ramos', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('marcioalvesramos90@hotmail.com', email.body)
        self.assertIn('15-996042331', email.body)
